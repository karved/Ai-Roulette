...
export default function ImprovedBettingChips() {
  ...
  const getChipStyle = (value: number) => {
    const baseStyle = "w-16 h-16 rounded-full border-2 border-gray-600 flex items-center justify-center font-bold text-white cursor-pointer transition-all hover:scale-110 shadow-lg"
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
      <h3 className="text-lg font-semibold text-white mb-4 text-center">Betting Chips</h3>
